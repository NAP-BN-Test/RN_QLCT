    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      <ScrollView>
        <View>
          ...
          <ItemOption iconRight="monetization-on" name="Ví của tôi" />
          <ItemOption name="Công cụ" iconRight="construction" />
          <ItemOption name="Cài đặt" iconRight="settings" />
          <ItemOption name="Hỗ trợ" iconRight="phone-in-talk" />
          <ItemOption name="Giới thiệu" iconRight="assignment-ind" />
        </View>
